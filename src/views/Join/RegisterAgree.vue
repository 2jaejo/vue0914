...
<!-- 회원가입약관 동의 시작 { -->
            <div id="register_agree">
                ...
                <v-ons-list>         
                    <v-ons-list-item>
                        <div class="right">
                            <v-ons-checkbox v-model="agree1" value="1" input-id="agree11"></v-ons-checkbox>
                        </div>
                        <div class="center">
                            <label style="width:100%;" for="agree11">이용약관 동의<span>(필수)</span></label>
                        </div>
                    </v-ons-list-item>
                    
                    <v-ons-list-item style="border-bottom:2px solid #ccc;">
                        <div class="center">
                            <textarea class="textarea" readonly="" rows="5" cols="50"
                    ...
                    <v-ons-list-item>
                        <div class="right">
                            <v-ons-checkbox v-model="agree2" value="1" input-id="agree21"></v-ons-checkbox>
                        </div>
                        <div class="center">
                            <label style="width:100%;" for="agree21">개인정보 수집 및 이용 동의<span>(필수)</span></label>
                        </div>
                    </v-ons-list-item>
                    ...
                    <v-ons-list-item style="border-bottom:2px solid #ccc;">
                        <div class="center">
                            ...
                            >
                                ...
                                1) 공고일자 : 2021년 01월 01일
                                2) 시행일자 : 2021년 01월 01일 
                            </textarea>
                        </div>
                    </v-ons-list-item>
                    <v-ons-list-item style="border-bottom:2px solid #ccc;">
                        <div class="right">
                            <v-ons-checkbox v-model="chk_all" value="1" input-id="chk_all" @click="checkedAll($event.target.checked)"></v-ons-checkbox>
                        </div>
                        <div class="center">
                            <label style="width:100%;" for="chk_all">회원가입 약관에 모두 동의합니다</label>
                        </div>
                    </v-ons-list-item>

                    <v-ons-list-item>
                        <div class="center">
                            <v-ons-button class="outline-btn" modifier="large outline" @click="pop()">취소</v-ons-button>
                        </div>
                    </v-ons-list-item>

                    <v-ons-list-item>
                        <div class="center">
                            <v-ons-button class="search-btn" modifier="large" @click="push()">동의</v-ons-button>    
                        </div>
                    </v-ons-list-item> 
    ...
    methods: {
        ...
        push() {
            if(!this.agree1){
                ...
                title: '약관 동의',
                message: '회원가입 약관에 동의하셔야 가입하실 수 있습니다.',
                });
                return false;
            }
            ...
            if(!this.agree2){
                this.$ons.notification.alert({
                title: '약관 동의',
                message: '개인정보수집 약관에 동의하셔야 가입하실 수 있습니다.'
                });
                return false;
            }
